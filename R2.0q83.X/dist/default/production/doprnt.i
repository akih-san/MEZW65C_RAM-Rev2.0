...
static void efgtoa(FILE *fp, long double f, char c)
{
 ...
 mode = c;
    ...
    nmode = mode;
# 695 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
 {
        p = (prec < 0) ? 6 : prec;
    }
# 711 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    m = p;
 ...
 ne = e;
    ...
    while ((i < m) && (n < (80 - 5))) {
        l = floorf(h/u.f);
        d = (int)l > 9 ? 9 : (int)l;
# 792 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
  {
            if (!pp && (ne < 0)) {
                dbuf[n++] = '.';
                --w;
 ...
 i = sizeof(dbuf) - 1;
    dbuf[i] = '\0';
# 848 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
...
# 1052 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
...
# 1076 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    ...
    w = width;
# 1091 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
 a = x == 'x' ? 'a' : 'A';
...
# 1291 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
  ...
  c = *cp;
  switch(c) {
# 1308 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
   case 'l':
    cp++;
    ...
    break;
# 1338 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
   case 'i':
   case 'd':
  ...
  if (*cp == 'd' || *cp == 'i') {
   ...
   switch (c) {
    case 'i':
     ...
     break;
# 1378 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    case 'l':
     convarg.sint = (vfpf_sint_t)(*(long *)__va_arg(*(long **)ap, (long)0));
     break;
# 1402 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
   }
  ...
  if (0
   ...
   switch (c) {
    case 'i':
     ...
     break;
# 1469 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    case 'l':
     convarg.uint = (vfpf_uint_t)(*(unsigned long *)__va_arg(*(unsigned long **)ap, (unsigned long)0));
     break;
# 1493 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
   }
...
# 1682 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
  ...
  switch(c) {
   ...
   case 'L':
    cp++;
    break;
# 1710 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
   case 'f':
# 1721 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    c = 'l';
    break;
   default:
    c = 0;
  ...
  if (0
# 1742 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    || *cp == 'f'
# 1753 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    ) {
   switch (c) {
    case 'l':
   ...
   *fmt = cp+1;
   switch (*cp) {
# 1779 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    case 'f':
# 1790 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
