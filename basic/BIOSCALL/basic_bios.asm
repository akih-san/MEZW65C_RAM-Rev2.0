...
Ram_top          equ $C000     ; end of user RAM+1 (set as needed, should be page aligned)
...
reg_ts	dw	0	; reserve
nmi_sw	db	0	; reserve
bios_sw	db	1	; 1 : program call bios command
;--------- MEZW65C_RAM file header --------------------------
LAB_COLD
