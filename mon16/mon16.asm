...
reserve		ds	1	;
irq_tgl		ds	1
ZCIN_BP		ds	2	; Indirect Index conin buffer pointer
ZCOUT_BP	ds	2	; Indirect Index conout buffer pointer
...
; Console buffer
;
COUT_BUF	ds	COUT_SIZE	; 128byte console output buffer
CIN_BUF		ds	CIN_SIZE
CIN_CT		ds	1		; CIN buffer counter
CIN_RP		ds	1		; CIN buffer Read pointer
CIN_WP		ds	1		; CIN buffer Write pointer
COUT_CT		ds	1		; COUT buffer counter
COUT_RP		ds	1		; COUT buffer Read pointer
COUT_WP		ds	1		; COUT buffer Write pointer
CONTMP_BUF	ds	COUT_SIZE
...
NMI_E:
	...
	STA	REGPSR		; save status register
	STA	FLAGS		; save status register
