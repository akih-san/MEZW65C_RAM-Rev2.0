...
それを使って作成します。<br>
- [ファイルヘッダ](https://github.com/akih-san/MEZW65C_RAM-Rev2.0/blob/main/file_header/fileheader.pdf)
<br>
...
<br>
BIOSコールを実装するために、モニタープログラムが常駐しています。<br>
BIOSコールは、6502のBRK命令を実行することで呼び出します。<br>
BISOコールとして５つの機能を提供しています。<br>
<br>

![aa](photo/bios_call.png)

<br>
モニタープログラムはネイティブモニタと、エミュレーションモニタの２つが用意されています。<br>
W65C02使用時はエミュレーションモニタが使用されます。<br>
<br>
...
W65C02Sでは、10MHzで動作しますが、連続試験はしていません。<br>
