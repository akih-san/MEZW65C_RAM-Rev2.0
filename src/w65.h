...
//#define bioreq_ubuffadr	0x18			// monitor request IO header address
//#define bioreq_cbuffadr	0x1a			// function request IO header address
...
//-- user I/F block ---------------------------------------------------------
	...
	uint32_t data_adr;		// uint16_t adr;		16bit address(W65C02)
						// uint8_t  bank;		bank address(W65C816 ONLY) 0:(W65C02)
						// uint8_t  reserve;	must be 0
} crq_hdr;
