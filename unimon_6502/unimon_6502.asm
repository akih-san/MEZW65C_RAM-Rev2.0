...
;
;	which BRK or IRQ?
;	need status condhition check (SP + 1)
...
;---------- unimon message data ---------------
OPNMSG
	FCB	CR,LF,"Universal Monitor W65C02",CR,LF
	fcb	"CPU : ",$00
PROMPT
	FCB	"] ",$00
IHEMSG
...
NMIMSG	FCB	"Detect NMI!",CR,LF,$00
BRKMSG	FCB	"Detect IRQ/BRK!",CR,LF,$00
